            ...
            date: function (value, format) {
                ...
                try {
                    ...
                    for (var i = 0; i < format.length; i++) {
                        ...
                        switch (pattern) {
                            case "dd":
                                retValue += dayOfMonth.toString().length==1 ? "0" + dayOfMonth : dayOfMonth;
                                pattern = "";
                                break;
                            case "MMM":
                            ...
                            case "mm":
                                ...
                                retValue += month.toString().length==1 ? "0" + month : month ;
                                pattern = "";
                                break;
                            case "yy":    
                            case "yyyy":
...
$(document).ready(function () {
    ...
    $(".longDateFormat").each(function (idx, elem) {
        if ($(elem).is(":input")) {
            $(elem).val($.format.date($(elem).val(), 'dd/mm/yyyy h:m:s'));
        } else {
            $(elem).text($.format.date($(elem).text(), 'dd/mm/yyyy h:m:s'));
        }
    });
});
